...
import br.com.marlon.screenmatch.model.*;
import br.com.marlon.screenmatch.repository.SerieRepository;
    ...
    private void buscarEpisodioPorSerie() {
        ...
        if(serie.isPresent()) {
            ...
            for (int i = 1; i <= serieEncontrada.getTotalTemporadas(); i++) {
                var json = consumo.obterDados(ENDERECO + serieEncontrada.getTitulo().replace(" ", "+") + APIKEY);
